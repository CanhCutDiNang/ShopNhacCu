                    ...
                    new OnSuccessListener<Location>() {
                        ...
                        public void onSuccess(Location location) {
                            if (location != null) {
                                ...
                                double kd = Double.parseDouble(kinhdo.getText().toString());
                                double vd = Double.parseDouble(vido.getText().toString());
                                Log.d("Vi Tri Cua Ban La",kd+"vi do"+vd);
                                LatLng home = new LatLng(kd, vd);
                                mMap.addMarker(new MarkerOptions()
                                        .position(home)
                                        .title("Vị Trí Của Bạn"));
                                LatLng truong = new LatLng(13.002812951579306, 109.23347357731872);
                                mMap.addPolyline(new PolylineOptions().add(home, truong).color(R.color.com_facebook_blue));
